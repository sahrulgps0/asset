<?php $__env->startSection('content2'); ?>
    ...
    <div class="dashboard-body-part">
        <button data-href="<?php echo e(route('user.plan.delete', auth()->user()->id)); ?>" class="sp_theme_btn planDelete mb-4"><i class="fa fa-trash mr-1"></i>
            <?php echo e('Delete Plan'); ?></button>
        <div class="row gy-4">
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/dashboard.blade.php ENDPATH**/ ?>