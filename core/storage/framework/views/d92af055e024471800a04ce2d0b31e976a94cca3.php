<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <div class="header-right d-flex d-none  d-md-none d-lg-block">
            <?php if(Auth::user()): ?>
                <a href="<?php echo e(route('user.dashboard')); ?>" class="sp_btn_border sp_btn_sm me-3"><?php echo e(__('Dashboard')); ?></a>
            <?php else: ?>
                <a href="<?php echo e(route('user.login')); ?>" class="sp_btn_border sp_btn_sm me-3"><?php echo e(__('Login')); ?></a>
            <?php endif; ?>
...
<?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>