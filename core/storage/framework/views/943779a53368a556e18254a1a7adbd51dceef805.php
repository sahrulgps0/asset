                        ...
                        <div class=" mt-4">
                            <div class="card bg-second">
                                ...
                                <form action="<?php echo e(route('blogcomment', @$data->id)); ?>" method="post" role="form"
                                    ...
                                    <button class="sp_theme_btn" type="submit"><?php echo e(__('Post Comemnt')); ?></button>
                                </form>
...
<?php echo $__env->make(template().'layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/pages/blog.blade.php ENDPATH**/ ?>