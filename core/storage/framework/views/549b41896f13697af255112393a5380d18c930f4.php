        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-7 col-lg-8 text-lg-start text-center">
                ...
                <div class="banner-btn-group justify-content-lg-start justify-content-center mt-4">
                    ...
                    <a href="<?php echo e(__($content->data->button_text_2_link)); ?>" class="sp_border_btn"><?php echo e(__($content->data->button_text_2)); ?></a>
                </div>
...
<div class="calculate-area">
    ...
    <div class="container">
        <div class="row gy-4 align-items-end">
            ...
            <div class="col-lg-3">
                <a href="#" id="calculate-btn" class="sp_theme_btn w-100"> <?php echo e(__('Calculate Earning')); ?></a>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/sections/banner.blade.php ENDPATH**/ ?>