        ...
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2"><?php echo e(__('Haven\'t an Account?')); ?></span> <a
                        class="sp_theme_btn sp_btn_sm" href="<?php echo e(route('user.register')); ?>"><?php echo e(__('Register')); ?></a></p>
            </div>
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="" method="POST">
                        ...
                        <?php endif; ?>
                        <button class="sp_theme_btn w-100" type="submit"> <?php echo e(__('Log In')); ?> </button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/auth/login.blade.php ENDPATH**/ ?>