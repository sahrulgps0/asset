                    ...
                    <div class="card-body">
                        ...
                        <?php elseif($data['user']->loginSecurity->google2fa_enable): ?>
                            ...
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('user.disable2fa')); ?>">
                                ...
                                <button type="submit" class="sp_btn sp_theme_btn"><?php echo e(__('Disable 2FA')); ?></button>
                            </form>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/2fa_settings.blade.php ENDPATH**/ ?>