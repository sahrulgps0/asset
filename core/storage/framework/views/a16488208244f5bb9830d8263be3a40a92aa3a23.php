                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let html = `
                                ...
                                <div class="col-md-12">
                                   <button class="sp_theme_btn w-100" type="submit"><?php echo e(__('Withdraw Now')); ?></button>
                                </div>
                   `;
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/withdraw/index.blade.php ENDPATH**/ ?>