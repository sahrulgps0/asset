    ...
    <section class="auth-section auth-section-two">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2"><?php echo e(__('Already registered?')); ?></span> <a class="sp_theme_btn sp_btn_sm" href="<?php echo e(route('user.login')); ?>"><?php echo e(__('Login')); ?></a></p>
            </div>
                ...
                <div class="auth-form-wrapper">
                    ...
                    <form action="<?php echo e(route('user.register')); ?>" method="POST">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-12">
                                <button class="sp_theme_btn w-100" type="submit"> <?php echo e(__('Register')); ?> </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/auth/register.blade.php ENDPATH**/ ?>