            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="<?php echo e(route('user.forgot.password')); ?>" method="POST">
                        ...
                        <?php endif; ?>
                        <div class="mb-3">
                            <button type="submit" id="recaptcha" class="sp_theme_btn w-100"><?php echo e(__('Send Verification Code')); ?></button>
                        </div>
                        <div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/auth/forgot_password.blade.php ENDPATH**/ ?>