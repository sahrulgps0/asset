        ...
        <div class="row">
            <div class="col-xxl-4 col-lg-5 text-md-start text-center">
                <div class="site-header">
                    <h2 class="site-title"><?php echo e(@$investor->data->title); ?></h2>
                </div>
            </div>
        </div>
...
<!-- investor section end --><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/sections/investor.blade.php ENDPATH**/ ?>