                            ...
                            <div class="invest-plan-action mt-3">
                                ...
                                <?php else: ?>
                                    <a class="sp_theme_btn w-100 mb-3"
                                        ...
                                        <button class="sp_theme_btn w-100 balance" data-plan="<?php echo e($plan); ?>"
            ...
            <form action="<?php echo e(route('user.investmentplan.submit')); ?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="sp_btn sp_btn_secondary" data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                        <button type="submit" class="sp_btn sp_theme_btn"><?php echo e(__('Invest Now')); ?></button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make(template().'layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/pages/investmentplan.blade.php ENDPATH**/ ?>