                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6">
                    <div class="payment-box text-center">
                        ...
                        <div class="payment-box-content">
                            ...
                            <button data-href="<?php echo e(route('user.paynow', $gateway->id)); ?>" data-id="<?php echo e($gateway->id); ?>" class="sp_theme_btn w-100 paynow mt-3"><?php echo e(__('Pay Now')); ?></button>
                        </div>
                    </div>
                </div>
            ...
            <form action="" method="post">
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="sp_theme_btn"><?php echo e(__('Deposit Now')); ?></button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <form action="" method="post">
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="sp_btn sp_btn_danger"
                            data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                        <button type="submit" class="sp_theme_btn"><?php echo e(__('Invest Now')); ?></button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gerr4748/public_html/ava-trade.asia/core/resources/views/frontend/user/gateway/gateways.blade.php ENDPATH**/ ?>